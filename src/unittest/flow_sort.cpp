...
P	13	path4	5	+	1M)";
        ...
        // should be from manual calculation
        //1 6 10 5 7 9 4 8 2 16 11 15 17 12 14 13 3 
        REQUIRE(res.str().compare("1 6 5 7 10 9 4 8 2 11 15 16 17 12 14 13 3") == 0);
    }
...
P	21	path12	3	+	1M)";
        ...
        REQUIRE(res.str().compare("1 5 6 7 9 12 11 8 10 4 13 16 19 18 14 17 15 2 22 23 25 28 27 24 26 20 29 32 35 34 30 33 31 21 3") == 0);
    }
}
}
}